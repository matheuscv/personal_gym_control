...
export const EXERCISE_LIBRARY: LibraryGroup[] = [
  group('Peito', [
    ...
    ['Supino reto com halteres', ...s3('10-12')],
    ['Supino inclinado com barra', ...s3('8-12')],
    ['Supino inclinado com halteres', ...s3('10-12')],
    ...
    ['Supino máquina', ...s3('10-12')],
    ['Flexão de braço', ...s3('12-20')],
    ['Flexão de braço com pés elevados', ...s3('10-15')],
    ['Pullover com halteres', ...s3('10-12')],
  ]),
  group('Costas', [
    ['Puxada na polia alta (pulldown)', ...s3('10-12')],
    ['Puxada na polia alta pegada supinada', ...s3('10-12')],
    ['Barra fixa (pull-up)', ...s3('6-10')],
    ['Remada curvada com barra', ...s3('8-12')],
    ['Remada curvada com halteres', ...s3('10-12')],
    ['Remada unilateral com halter (serrote)', ...s3('10-12')],
    ['Remada baixa na polia (cabo)', ...s3('10-12')],
    ['Remada cavalinho (T-bar)', ...s3('8-12')],
    ['Remada máquina articulada', ...s3('10-12')],
  ...
  group('Ombros', [
    ...
    ['Desenvolvimento de ombro com halteres', ...s3('10-12')],
    ['Desenvolvimento máquina (press)', ...s3('10-12')],
    ...
    ['Remada alta com barra', ...s3('10-12')],
    ['Face pull na polia', ...s3('12-15')],
    ['Arnold press com halteres', ...s3('10-12')],
  ]),
  group('Bíceps', [
    ['Rosca direta com barra', ...s3('8-12')],
    ['Rosca direta com barra W', ...s3('8-12')],
    ['Rosca alternada com halteres', ...s3('10-12')],
    ['Rosca martelo com halteres', ...s3('10-12')],
    ['Rosca concentrada com halter', ...s3('10-12')],
    ['Rosca scott (banco Scott)', ...s3('10-12')],
    ['Rosca na polia baixa', ...s3('12-15')],
    ['Rosca 21 com barra', ...s3('7-7-7')],
  ]),
  group('Tríceps', [
    ['Tríceps na polia (pushdown)', ...s3('10-12')],
    ['Tríceps na polia com corda', ...s3('12-15')],
    ['Tríceps testa com barra', ...s3('10-12')],
    ['Tríceps testa com halteres', ...s3('10-12')],
    ['Tríceps francês com halter (unilateral)', ...s3('10-12')],
  ...
  group('Quadríceps', [
    ...
    ['Agachamento com halteres (goblet squat)', ...s3('10-12')],
    ['Leg press 45°', ...s3('10-15')],
    ['Cadeira extensora', ...s3('12-15')],
    ['Agachamento hack (hack squat)', ...s3('10-12')],
    ['Agachamento smith (máquina Smith)', ...s3('10-12')],
    ...
    ['Agachamento sumô com halter', ...s3('10-12')],
  ]),
  group('Posterior de coxa', [
    ['Stiff / levantamento romeno com barra', ...s3('10-12')],
    ['Stiff / levantamento romeno com halteres', ...s3('10-12')],
    ...
    ['Good morning com barra', ...s3('10-12')],
  ]),
  group('Glúteos', [
    ['Elevação de quadril (hip thrust)', ...s3('12-15')],
    ['Hip thrust com barra', ...s3('10-12')],
