...
export const BODY_MEASUREMENT_FIELDS: BodyMeasurementField[] = [
  ...
  { key: 'biceps_relaxado_direito_cm', label: 'Bíceps relaxado direito', group: 'Membros superiores', optional: true },
  { key: 'biceps_relaxado_esquerdo_cm', label: 'Bíceps relaxado esquerdo', group: 'Membros superiores', optional: true },
  ...
  { key: 'coxa_medial_direita_cm', label: 'Coxa medial direita', group: 'Membros inferiores', optional: true },
  { key: 'coxa_medial_esquerda_cm', label: 'Coxa medial esquerda', group: 'Membros inferiores', optional: true },
